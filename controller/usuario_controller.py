...
from api.domain.dto.dtos import UsuarioCreateDTO, UsuarioDTO, UsuarioUpdateDTO
...
@user_router.get('/{user_id}', status_code=200, description='Buscar usuario por ID', response_model=UsuarioDTO)
...
@user_router.get('/', status_code=200, description='Buscar todos os usuários', response_model=list[UsuarioDTO])
...
@user_router.put('/{user_id}', status_code=200, description='Atualizar um usuário', response_model=UsuarioDTO)
